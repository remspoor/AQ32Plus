...
#Libraries
LIBRARIES := Libraries/CMSIS/Include Libraries/CMSIS/Device/ST/STM32F4xx/Include
LIBRARIES += Libraries/STM32F4xx_StdPeriph_Driver/inc Libraries/STM32_USB_Device_Library/Core/inc
LIBRARIES += Libraries/STM32_USB_Device_Library/Class/cdc/inc Libraries/STM32_USB_OTG_Driver/inc
#-lboost_filesystem -lboost_thread -lboost_system -ldl -L$(ANOTHER_PROJECT_HOME) -lAnotherProjectLibrary -lpthread
